...
def main():
    ...
    results = []
    # here is evaluation of all feature combinations
    for combo in combos:
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('learning_curve_best_features.png')
    print("Learning curve saved as 'learning_curve_best_features.png'")
